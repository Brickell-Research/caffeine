...
dev-unlink:
	...
	cd caffeine_cli && sed -i '' 's|caffeine_lang = .*|caffeine_lang = ">= 5.0.10 and < 6.0.0"|' gleam.toml
	cd caffeine_lsp && sed -i '' 's|caffeine_lang = .*|caffeine_lang = ">= 5.0.10 and < 6.0.0"|' gleam.toml
